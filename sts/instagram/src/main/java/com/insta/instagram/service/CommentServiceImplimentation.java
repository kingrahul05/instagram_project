...
public class CommentServiceImplimentation implements CommentService {
	...
	public Comment createComment(Comment comment, Integer postId, Integer userId) throws UserException, PostException {
		...
		Comment createdComment=commentRepository.saved(comment);
		
		System.out.println("comment service --------"+createdComment);
	...
	public Comment likeComment(Integer commentId, Integer userId) throws CommentException, UserException {
		...
		comment.getLikeByUsers().add(userDto);
		
		
		
		
		return commentRepository.saved(comment);
	}
	...
	public Comment unlikeComment(Integer commentId, Integer userId) throws CommentException, UserException {
		...
		comment.getLikeByUsers().remove(userDto);
